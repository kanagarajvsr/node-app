...
const getAllRole = async (req, res) => {
    try {
        ...
        let result = await Role.findAndCountAll(query);
        result.page = page;
        result.limit = limit;
...
const getOneRole = async (req, res) => {
    try {
        ...
        let result = await Role.findOne({ where: { id: id }, attributes: { exclude: excludeFields } });
        return res.status(200).send({
            data: result,
            status: 200,
        });
...
const addRole = async (req, res) => {
    try {
        let data = {
            ...
            RoleId: process.data.RoleId,
            createdBy: process.data.RoleId
        };
